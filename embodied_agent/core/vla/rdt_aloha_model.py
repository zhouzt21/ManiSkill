...
from embodied_agent.third_party.vla.rdt.configs.state_vec import STATE_VEC_IDX_MAPPING
from embodied_agent.third_party.vla.rdt.models.multimodal_encoder.siglip_encoder import SiglipVisionTower
from embodied_agent.third_party.vla.rdt.models.multimodal_encoder.t5_encoder import T5Embedder
from embodied_agent.third_party.vla.rdt.models.rdt_runner import RDTRunner
...
class RoboticDiffusionTransformerModel(object):
    ...
    def _format_joint_to_state(self, joints):
        ...
        # )
        joints = joints  / torch.tensor(
            [[[1, 1, 1, 1, 1, 1, 0.045, 1, 1, 1, 1, 1, 1, 0.045]]],
            device=joints.device, dtype=joints.dtype
        )
