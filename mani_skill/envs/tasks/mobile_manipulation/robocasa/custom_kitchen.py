...
class RoboCasaCustomKitchenEnv(BaseEnv):
    ...
    # Here the ref is reference. It can be a pointer or the ref. We can use self.fixture_ref[scene_idx][ref_name] to find the scene.
    # The reference can be used for _get_obj_cfgs() func, the fixture can be self.counter(a reference) or self.fixture_ref[scene_idx][ref_name]
    def _setup_kitchen_references(self): 
        ...
        # unserialize refs
        # can also use register_fixture_ref to replace the code below.
