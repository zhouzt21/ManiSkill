...
def expert_action(env):
    """
    stage 1: right arm get closer to the cubeA, stay gripper open
    stage 2: close the gripper
    stage 3: move the cubeA to the center 
    stage 4: open the gripper
    stage 5: move back to the initial position
